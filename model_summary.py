...
def transcribe_audio(file_path, video_id):
    ...
    if size_mb < 25:
        with open(file_path, "rb") as audio_file:
            ...
            transcript = openai.Audio.translate(file=audio_file, model="whisper-1", response_format="text", language="en")
...
def generate_video_summary(api_key: str, url: str) -> str:
    ...
    llm = OpenAI(temperature=0, openai_api_key=api_key, model_name="gpt-4-turbo")
